<%@ Page Title="" Language="C#" MasterPageFile="~/Librarian/Librarian.Master" AutoEventWireup="true" CodeBehind="add_penalty.aspx.cs" Inherits="LibraryManagementSystem.Librarian.add_penalty" %>
                              ...
                              <div class="card-body"> 
                                  ...
                                  <form action="" id="fo1" runat="server" method="post" novalidate="novalidate">
                                      ...
                                      <div class="form-group">
                                          <label for="" class="control-label mb-1">Add/Edit Penalty(Rupees)</label>
